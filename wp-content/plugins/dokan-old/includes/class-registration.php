...
class Dokan_Registration {
    ...
    public function render_shortcode() {
        ...
        if ( is_user_logged_in() ) {
            esc_html_e( 'انت بالفعل مسجل', 'dokan-lite' );
            return;
        }
    ...
    function validate_registration( $error ) {
        ...
        $required_fields = apply_filters( 'dokan_seller_registration_required_fields', array(
            'fname'    => __( 'يرجى ادخال الاسم الاول.', 'dokan-lite' ),
            'lname'    => __( 'يرجى ادخال الاسم الاخير.', 'dokan-lite' ),
            'phone'    => __( 'يرجى ادخال رقم الهاتف.', 'dokan-lite' ),
            'shopname' => __( 'يرجى ادخال اسم المتجر.', 'dokan-lite' ),
        ) );
