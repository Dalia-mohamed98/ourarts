            ...
            'pointers' => array(
                ...
                'overview' => array(
                    ...
                    'options'      => array(
                        ...
                        '<p>' . esc_html__( 'احصل على نظرة عامة كاملة على المبيعات والأوامر والعمولات الخاصة بك.', 'dokan-lite' ) . '</p>',
                        'position' => array(
                            'edge'  => 'top',
                            'align' => 'left',
                        ),
                    ),
                    'next_button'  => "<button class='next button button-primary right'>" . __( 'التالي', 'dokan-lite' ) . "</button>"
                ),
                'updates'  => array(
                    'target'       => ".news-updates",
                    'next'         => '',
                    'next_trigger' => array(),
                    'options'      => array(
                        'content'  => '<h3>' . esc_html__( 'الأخبار والتحديثات', 'dokan-lite' ) . '</h3>' .
                        '<p>' . esc_html__( 'الحصول على جميع آخر الأخبار والتحديثات من Dokan من هنا.', 'dokan-lite' ) . '</p>',
                        'position' => array(
                            'edge'  => 'top',
                            'align' => 'left',
                        ),
