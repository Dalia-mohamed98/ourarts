...
function dokan_shop_order_custom_columns( $col ) {
    ...
    switch ($col) {
        ...
        case 'suborder':
            ...
            if ( $has_sub == '1' ) {
                printf( '<a href="#" class="show-sub-orders" data-class="parent-%1$d" data-show="%2$s" data-hide="%3$s">%2$s</a>', esc_attr( $post->ID ), esc_attr__( 'عرض الطلبات الفرعية', 'dokan-lite' ), esc_attr__( 'إخفاء الطلبات الفرعية', 'dokan-lite' ) );
            }
            break;
    ...
    <script type="text/javascript">
        jQuery(function($) {
            ...
            $(document).ready( function() {
                ...
                var series = [
                    {
                        label: "<?php echo esc_js( __( 'إجمالي المبيعات', 'dokan-lite' ) ) ?>",
                        ...
                        shadowSize: 0,
                        prepend_tooltip: "<?php echo esc_attr__( 'الإجمالي: ', 'dokan-lite') . esc_attr( get_woocommerce_currency_symbol() ); ?>"
                    },
                    {
                        label: "<?php echo esc_js( __( 'عدد الطلبات', 'dokan-lite' ) ) ?>",
                        ...
                        lines: { show: true, lineWidth: 4, fill: false },
                        shadowSize: 0,
                        append_tooltip: " <?php echo esc_attr__( 'المبيعات', 'dokan-lite' ); ?>"
                    },
                    {
                        label: "<?php echo esc_js( __( 'العمولة', 'dokan-lite' ) ) ?>",
                        ...
                        lines: { show: true, lineWidth: 4, fill: false },
                        shadowSize: 0,
                        prepend_tooltip: "<?php echo esc_attr__( 'العمولة: ', 'dokan-lite' ) . esc_attr( get_woocommerce_currency_symbol() ); ?>"
                    },
                ];
...
function dokan_seller_meta_box( $post ) {
    ...
    ?>
    <label class="screen-reader-text" for="dokan_product_author_override"><?php esc_html_e( 'التاجر', 'dokan-lite' ); ?></label>
...
function dokan_add_seller_meta_box(){
    ...
    add_meta_box( 'sellerdiv', __('التاجر', 'dokan-lite' ), 'dokan_seller_meta_box', 'product', 'normal', 'core' );
}
