...
class Dokan_Admin_User_Profile {
    ...
    function enqueue_scripts( $page ) {
        if ( in_array( $page, array( 'profile.php', 'user-edit.php' ) ) ) {
            ...
            $admin_admin_script = array(
                ...
                'seller'      => array(
                    'available'    => __( 'متاح', 'dokan-lite' ),
                    'notAvailable' => __( 'غير متاح', 'dokan-lite' ),
                ),
            );
    ...
    function add_meta_fields( $user ) {
        ...
        <table class="form-table">
            <tbody>
                <tr>
                    <th><?php esc_html_e( 'اللافتة', 'dokan-lite' ); ?></th>
                    <td>
                        <div class="dokan-banner">
                            ...
                            <div class="button-area<?php echo esc_attr( $banner ) ? ' dokan-hide' : ''; ?>">
                                <a href="#" class="dokan-banner-drag button button-primary"><?php esc_html_e( 'تحميل اللافتة', 'dokan-lite' ); ?></a>
                                <p class="description">
                                    <?php
                                    echo sprintf(
                                        esc_attr__( 'تحميل لافتة لمتجرك. حجم البانر هو
										(%1$sx%2$s) بكسل.', 'dokan-lite' ),
                ...
                <tr>
                    <th><?php esc_html_e( 'اسم المتجر', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'عنوان المتجر الإلكتروني', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'عنوان 1', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'عنوان 2', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'المدينة', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'الرمز البريدي', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'رقم الهاتف', 'dokan-lite' ); ?></th>
                    <td>
                ...
                <tr>
                    <th><?php esc_html_e( 'خيارات الدفع : ', 'dokan-lite' ); ?></th>
                </tr>

                <?php if ( isset( $store_settings['payment']['paypal']['email'] ) ) { ?>
                    <tr>
                        <th><?php esc_html_e( 'بريد باي بال ', 'dokan-lite' ); ?></th>
                        <td>
                ...
                <?php if ( isset( $store_settings['payment']['skrill']['email'] ) ) { ?>
                    <tr>
                        <th><?php esc_html_e( 'بريد سكريل ', 'dokan-lite' ); ?></th>
                        <td>
                ...
                <?php if ( isset( $store_settings['payment']['bank'] ) ) { ?>
                    <tr>
                        <th><?php esc_html_e( 'اسم البنك ', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'اسم الحساب ', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'رقم الحساب ', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'عنوان البنك ', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'رقم التوصيل', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'بنك IBAN ', 'dokan-lite' ); ?></th>
                        <td>
                    ...
                    <tr>
                        <th><?php esc_html_e( 'بنك سويفت ', 'dokan-lite' ); ?></th>
                        <td>
                ...
                <?php } ?>
                <tr>
                    <th><?php esc_html_e( 'بيع', 'dokan-lite' ); ?></th>
                    <td>
                        <label for="dokan_enable_selling">
                            ...
                            <?php esc_html_e( 'تمكين إضافة المنتجات', 'dokan-lite' ); ?>
                        </label>

                        <p class="description"><?php esc_html_e( 'تمكين أو تعطيل القدرة على إضافة المنتج  ', 'dokan-lite' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th><?php esc_html_e( 'نشر', 'dokan-lite' ); ?></th>
                    <td>
                        <label for="dokan_publish">
                            ...
                            <?php esc_html_e( 'نشر المنتج مباشرة', 'dokan-lite' ); ?>
                        </label>

                        <p class="description"><?php esc_html_e( 'تجاوز المعلقة ، ونشر المنتجات مباشرة', 'dokan-lite' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th><?php esc_html_e( 'نوع عمولة المشرف ', 'dokan-lite' ); ?></th>
                    <td>
                        <select id="dokan_admin_percentage_type" name="dokan_admin_percentage_type">
                            <option value="percentage" <?php selected( $admin_commission_type, 'percentage' ); ?> ><?php esc_html_e( 'نسبة', 'dokan-lite' ); ?></option>
                            <option value="flat" <?php selected( $admin_commission_type, 'flat' ); ?>><?php esc_html_e( 'فلات', 'dokan-lite' ); ?></option>
                        </select>
                        <p class="description"><?php esc_html_e( 'قم بتعيين المشرف على نوع الاتصال من هذا البائع', 'dokan-lite' ); ?></p>
                    </td>
                </tr>
                <tr>
                    <th><?php esc_html_e( 'عمولة المشرف', 'dokan-lite' ); ?></th>
                    <td>
                        <input type="text" class="small-text" name="dokan_admin_percentage" value="<?php echo esc_attr( $admin_commission ); ?>">

                        <p class="description"><?php esc_html_e( 'سيؤدي ذلك إلى تجاوز مسؤول العمولة الافتراضي الذي يحصل عليه من كل مبيعات', 'dokan-lite' ); ?></p>
                    </td>
                </tr>

                <tr>
                    <th><?php esc_html_e( 'تاجر مميز', 'dokan-lite' ); ?></th>
                    <td>
                        <label for="dokan_feature">
                            ...
                            <?php esc_html_e( 'وضع علامة على التاجر المميز', 'dokan-lite' ); ?>
                        </label>

                        <p class="description"><?php esc_html_e( 'سيتم تمييز هذا التاجر على أنه تاجر مميز.', 'dokan-lite' ); ?></p>
                    </td>
                </tr>
