<div id="dokan-seller-listing-wrap">
    <div class="seller-listing-content">
                    ...
                    <li class="dokan-single-seller woocommerce coloum-<?php echo esc_attr( $per_row ); ?> <?php echo ( ! $store_banner_id ) ? 'no-banner-img' : ''; ?>">
                        <div class="store-wrapper">
                                    ...
                                    <div class="store-data-container">
                                        <div class="featured-favourite">
                                            <?php if ( $is_store_featured ) : ?>
                                                <div class="featured-label"><?php esc_html_e( 'متميز', 'dokan-lite' ); ?></div>
                                            <?php endif ?>
                                        ...
                                        <div class="store-data">
                                            ...
                                            <?php if ( !empty( $store_rating['count'] ) ): ?>
                                                <div class="star-rating dokan-seller-rating" title="<?php echo sprintf( esc_attr__( 'تقييمه %s من 5', 'dokan-lite' ), esc_attr( $store_rating['rating'] ) ) ?>">
                                                    <span style="width: <?php echo ( esc_attr( ( $store_rating['rating'] / 5 ) ) * 100 - 1 ); ?>%">
                                                        <strong class="rating"><?php echo esc_html( $store_rating['rating'] ); ?></strong> <?php _e( 'من 5', 'dokan-lite' ); ?>
                                                    </span>
                                                </div>
                                            <?php endif ?>
                            ...
                            <div class="store-footer">
                                ...
                                <a href="<?php echo esc_url( $store_url ); ?>" class="dokan-btn dokan-btn-theme"><?php esc_html_e( 'زيارة المتجر', 'dokan-lite' ); ?></a>
        ...
        <?php else:  ?>
            <p class="dokan-error"><?php esc_html_e( 'لم يتم العثور على تاجر!', 'dokan-lite' ); ?></p>
        <?php endif; ?>
    </div>
</div>
