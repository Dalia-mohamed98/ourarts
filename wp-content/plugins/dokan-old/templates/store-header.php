...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'المتجر مفتوح', 'dokan-lite' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'المتجر مغلق', 'dokan-lite' );
    ...
    <div class="profile-info-box profile-layout-<?php echo esc_attr( $profile_layout ); ?>">
        ...
        <div class="profile-info-summery-wrapper dokan-clearfix">
            <div class="profile-info-summery">
                <div class="profile-info-head" style="float: none; margin: auto;">
                ...
                <div class="profile-info" style="float: none; margin: auto;">
                    <?php if ( ! empty( $store_user->get_shop_name() ) && 'default' !== $profile_layout ) { ?>
                        <h1 class="store-name" style="text-align: center;"><?php echo esc_html( $store_user->get_shop_name() ); ?></h1>
                    <?php } ?>

<!--                     <ul class="dokan-store-info"> -->
                        <?php //if ( isset( $store_address ) && !empty( $store_address ) ) { ?>
<!--                             <li class="dokan-store-address"><i class="fas fa-map-marker"></i> -->
