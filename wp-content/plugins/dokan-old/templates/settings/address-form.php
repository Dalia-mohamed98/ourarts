...
<div class="dokan-form-group">
    ...
    <div class="dokan-w5 dokan-text-left dokan-address-fields">
        <?php if ( $seller_address_fields['street_1'] ) { ?>
            <div class="dokan-form-group">
                <label class="dokan-w3 control-label" for="dokan_address[street_1]"><?php esc_html_e( 'الشارع 1 ', 'dokan-lite' ); ?>
                    <?php
                    $required_attr = '';
                ...
                <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ) ?> id="dokan_address[street_1]" value="<?php echo esc_attr( $address_street1 ); ?>" name="dokan_address[street_1]" placeholder="<?php esc_attr_e( 'عنوان الشارع' , 'dokan-lite' ) ?>" class="dokan-form-control input-md" type="text">
            </div>
        <?php }
        if ( $seller_address_fields['street_2'] ) { ?>
            <div class="dokan-form-group">
                <label class="dokan-w3 control-label" for="dokan_address[street_2]"><?php esc_html_e( 'الشارع 2', 'dokan-lite' ); ?>
                    <?php
                    $required_attr = '';
                ...
                <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ) ?> id="dokan_address[street_2]" value="<?php echo esc_attr( $address_street2 ); ?>" name="dokan_address[street_2]" placeholder="<?php esc_attr_e( 'شقة، جناح، وحدة الخ (اختياري)' , 'dokan-lite' ) ?>" class="dokan-form-control input-md" type="text">
            </div>
        <?php }
            ...
            <div class="dokan-from-group">
                <?php if ( $seller_address_fields['city'] ) { ?>
                    <div class="dokan-form-group dokan-w6 dokan-left dokan-right-margin-30">
                        <label class="control-label" for="dokan_address[city]"><?php esc_html_e( 'المدينة', 'dokan-lite' ); ?>
                            <?php
                            $required_attr = '';
                        ...
                        <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ) ?> id="dokan_address[city]" value="<?php echo esc_attr( $address_city ); ?>" name="dokan_address[city]" placeholder="<?php esc_attr_e( 'المدينة' , 'dokan-lite' ) ?>" class="dokan-form-control input-md" type="text">
                    </div>
                <?php }
                if ( $seller_address_fields['zip'] ) { ?>
                    <div class="dokan-form-group dokan-w5 dokan-left">
                        <label class="control-label" for="dokan_address[zip]"><?php esc_html_e( 'الرمز البريدي', 'dokan-lite' ); ?>
                            <?php
                            $required_attr = '';
                        ...
                        <input <?php echo esc_attr( $required_attr ); ?> <?php echo esc_attr( $disabled ) ?> id="dokan_address[zip]" value="<?php echo esc_attr( $address_zip ); ?>" name="dokan_address[zip]" placeholder="<?php esc_attr_e( 'الرمز البريدي' , 'dokan-lite' ) ?>" class="dokan-form-control input-md" type="text">
                    </div>
                <?php } ?>
        ...
        ?>
            <div class="dokan-form-group">
                <label class="control-label" for="dokan_address[country]"><?php esc_html_e( 'البلد ', 'dokan-lite' ); ?>
                    <?php
                    $required_attr = '';
        ...
        ?>
            <div  id="dokan-states-box" class="dokan-form-group">
                <label class="dokan-w3 control-label" for="dokan_address[state]"><?php esc_html_e( 'الدولة ', 'dokan-lite' ); ?>
                    <?php
                    $required_attr = '';
