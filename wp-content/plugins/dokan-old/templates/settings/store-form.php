...
<?php do_action( 'dokan_settings_before_form', $current_user, $profile_info ); ?>
    ...
    <form method="post" id="store-form"  action="" class="dokan-form-horizontal">
        ...
        <?php wp_nonce_field( 'dokan_store_settings_nonce' ); ?>
            ...
            <div class="dokan-banner">
                ...
                <div class="button-area<?php echo $banner_id ? ' dokan-hide' : ''; ?>">
                    ...
                    <a href="#" class="dokan-banner-drag dokan-btn dokan-btn-info dokan-theme"><?php esc_html_e( 'تحميل لافتة', 'dokan-lite' ); ?></a>
                    <p class="help-block">
                        <?php
                        /**
                        ...
                        $help_text = sprintf(
                            __(' تحميل لافتة لمتجرك. حجم البانر هو(%sx%s) بكسل.', 'dokan-lite' ),
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_gravatar"><?php esc_html_e( 'الصوره الشخصيه', 'dokan-lite' ); ?></label>
            ...
            <div class="dokan-w5 dokan-gravatar">
                ...
                <div class="gravatar-button-area<?php echo esc_attr( $gravatar_id ) ? ' dokan-hide' : ''; ?>">
                    <a href="#" class="dokan-pro-gravatar-drag dokan-btn dokan-btn-default"><i class="fa fa-cloud-upload"></i> <?php esc_html_e( 'تحميل الصورة', 'dokan-lite' ); ?></a>
                </div>
            </div>
        </div>

        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_store_name"><?php esc_html_e( 'اسم المتجر', 'dokan-lite' ); ?></label>

            <div class="dokan-w5 dokan-text-left">
                <input id="dokan_store_name" required value="<?php echo esc_attr( $storename ); ?>" name="dokan_store_name" placeholder="<?php esc_attr_e( 'اسم المتجر', 'dokan-lite' ); ?>" class="dokan-form-control" type="text">
            </div>
        </div>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="dokan_store_ppp"><?php esc_html_e( 'تخزين المنتج لكل صفحة', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="setting_phone"><?php esc_html_e( 'رقم الهاتف', 'dokan-lite' ); ?></label>
            <div class="dokan-w5 dokan-text-left">
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label"><?php esc_html_e( 'البريد الإلكتروني', 'dokan-lite' ); ?></label>
            <div class="dokan-w5 dokan-text-left">
                <div class="checkbox">
                    <label>
                        <input type="hidden" name="setting_show_email" value="no">
                        <input type="checkbox" name="setting_show_email" value="yes"<?php checked( $show_email, 'yes' ); ?>> <?php esc_html_e( 'إظهار عنوان البريد الإلكتروني في المتجر', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label"><?php esc_html_e( 'المزيد من المنتجات', 'dokan-lite' ); ?></label>
            <div class="dokan-w5 dokan-text-left">
                <div class="checkbox">
                    <label>
                        <input type="hidden" name="setting_show_more_ptab" value="no">
                        <input type="checkbox" name="setting_show_more_ptab" value="yes"<?php checked( $show_more_ptab, 'yes' ); ?>> <?php esc_html_e( 'تمكين علامة في عرض صفحة واحدة للمنتج', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
        ...
        <div class="dokan-form-group">
            <label class="dokan-w3 dokan-control-label" for="setting_map"><?php esc_html_e( 'الخريطة', 'dokan-lite' ); ?></label>
            ...
            <div class="dokan-w6 dokan-text-left">
                ...
                <div class="dokan-map-wrap">
                    <div class="dokan-map-search-bar">
                        <input id="dokan-map-add" type="text" class="dokan-map-search" value="<?php echo esc_attr( $map_address ); ?>" name="find_address" placeholder="<?php esc_attr_e( 'اكتب عنوان للعثور عليه', 'dokan-lite' ); ?>" size="30" />
                        <a href="#" class="dokan-map-find-btn" id="dokan-location-find-btn" type="button"><?php esc_html_e( 'بحث عن العنوان', 'dokan-lite' ); ?></a>
                    </div>
        ...
        if ( $tnc_enable == 'on' ) :
            ?>
            <div class="dokan-form-group">
                <label class="dokan-w3 dokan-control-label"><?php esc_html_e( 'الشروط و الأحكام', 'dokan-lite' ); ?></label>
                <div class="dokan-w5 dokan-text-left dokan_tock_check">
                    <div class="checkbox">
                        <label>
                            <input type="checkbox" id="dokan_store_tnc_enable" value="on" <?php echo $enable_tnc == 'on' ? 'checked':'' ; ?> name="dokan_store_tnc_enable"> <?php esc_html_e( 'عرض الأحكام والشروط في صفحة المتجر', 'dokan-lite' ); ?>
                        </label>
                    </div>
                </div>
            </div>
            <div class="dokan-form-group" id="dokan_tnc_text">
                <label class="dokan-w3 dokan-control-label" for="dokan_store_tnc"><?php esc_html_e( 'تفاصيل جدول المحتويات', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group store-open-close-time">
            <label class="dokan-w3 control-label" for="dokan-store-close">
                <?php esc_html_e( 'وقت افتتاح و إغلاق المتجر', 'dokan-lite' ); ?>
            </label>
            ...
            <div class="dokan-w5 dokan-text-left dokan_tock_check">
                <div class="checkbox">
                    <label for="dokan-store-time-enable" class="control-label">
                        ...
                        <?php esc_html_e( 'إظهار وقت فتح و إغلاق المتجر في صفحة المتجر', 'dokan-lite' ); ?>
                    </label>
                </div>
            </div>
        </div>
                        ...
                        <label for="">
                            <select name="<?php echo esc_attr( $day ) ?>_on_off" class="dokan-on-off dokan-form-control">
                                <option value="close" <?php ! empty( $status ) ? selected( $status, 'close' ) : '' ?> >
                                    <?php esc_html_e( 'مغلق', 'dokan-lite' ); ?>
                                </option>
                                <option value="open" <?php ! empty( $status ) ? selected( $status, 'open' ) : '' ?> >
                                    <?php esc_html_e( 'مفتوح', 'dokan-lite' ); ?>
                                </option>
                            </select>
                        </label>
        ...
        <div class="dokan-form-group store-open-close">
            <label class="dokan-w3 control-label" for="dokan-store-time-notice">
                <?php esc_html_e( 'ملاحظة فتح المتجر', 'dokan-lite' ); ?>
            </label>
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" name="dokan_store_open_notice" placeholder="<?php esc_attr_e( 'المتجر مفتوح', 'dokan-lite' ) ?>" value="<?php echo esc_attr( $dokan_store_open_notice ); ?>">
                </div>
            </div>
        </div>
        <div class="dokan-form-group store-open-close">
            <label class="dokan-w3 control-label" for="dokan-store-time-notice">
                <?php esc_html_e( 'ملاحظة غلق المتجر', 'dokan-lite' ); ?>
            </label>
            <div class="dokan-w6" style="width: auto">
                <div class="dokan-form-group">
                    <input type="text" class="dokan-form-control input-md" name="dokan_store_close_notice" placeholder="<?php esc_attr_e( 'المتجر مغلق', 'dokan' ) ?>" value="<?php echo esc_attr( $dokan_store_close_notice ); ?>">
                </div>
            </div>
        </div>
        <?php endif; ?>
        ...
        <div class="dokan-form-group">
            ...
            <div class="dokan-w4 ajax_prev dokan-text-left" style="margin-left:24%;">
                <input type="submit" name="dokan_update_store_settings" class="dokan-btn dokan-btn-danger dokan-btn-theme" value="<?php esc_attr_e( 'تحديث الاعدادات', 'dokan-lite' ); ?>">
            </div>
        </div>
    </form>
