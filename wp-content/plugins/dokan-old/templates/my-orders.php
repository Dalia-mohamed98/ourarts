...
<?php
    ...
    if ( $customer_orders ) : ?>
        ...
        <h2><?php echo esc_html( apply_filters( 'woocommerce_my_account_my_orders_title', __( 'الطلبيات الأخيرة', 'dokan-lite' ) ) ); ?></h2>
        ...
        <table class="shop_table my_account_orders table table-striped">
            ...
            <thead>
                <tr>
                    ...
                    <th class="order-total"><span class="nobr"><?php esc_html_e( 'التاجر', 'dokan-lite' ); ?></span></th>
                ...
                foreach ( $customer_orders as $customer_order ) {
                    ...
                    ?><tr class="order">
                        ...
                        <td class="order-total">
                            <?php echo sprintf( _n( '%s ل %s مادة', '%s for %s items', esc_html( $item_count ), 'dokan-lite' ), $order->get_formatted_order_total(), esc_html( $item_count ) ); ?>
                        </td>
                        ...
                        <td class="order-total">
                            <?php
                                ...
                                if ( !is_array( $seller_id ) && $seller_id != 0 ) {
                                    ...
                                    esc_html_e( 'تاجر متعدد', 'dokan-lite' );
                                }
                            ?>
                        </td>
    ...
    <?php else: ?>
        ...
        <p class="dokan-info"><?php esc_html_e( 'لم يتم العثور على طلبات!', 'dokan-lite' ); ?></p>
