...
<div class="order_download_permissions wc-metaboxes-wrapper">
    ...
    <div class="toolbar dokan-clearfix">
        ...
        <div class="dokan-w7" style="margin-right: 5px;">
            <select name="grant_access_id" class="grant_access_id dokan-select2 dokan-form-control" data-placeholder="<?php esc_attr_e( 'اختيار منتج للتحميل&hellip;', 'dokan-lite' ) ?>" multiple="multiple">
                <?php
        ...
        <div class="dokan-w4">
            <button type="button" class="dokan-btn dokan-btn-success grant_access" data-order-id="<?php esc_attr_e( dokan_get_prop( $order, 'id' ) ); ?>" data-nonce="<?php esc_attr_e( wp_create_nonce( 'grant-access' ) ); ?>"><?php esc_html_e( 'منح الحق', 'dokan-lite' ); ?></button>
        </div>
