        ...
        <div class="dokan-dashboard-content">
            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    <?php esc_html_e( 'اضف منتج جديد', 'dokan-lite' ); ?>
                </h1>
            </header><!-- .entry-header -->
            ...
            <div class="dokan-new-product-area">
                ...
                <?php if ( isset( $get_data['created_product'] ) ): ?>
                    <div class="dokan-alert dokan-alert-success">
                        <a class="dokan-close" data-dismiss="alert">&times;</a>
                        <strong><?php esc_html_e( 'عمل ناجح!', 'dokan-lite' ); ?></strong>
                        <?php printf( __( 'لقد اضفت بنجاح <a href="%s"><strong>%s</strong></a> المنتج', 'dokan-lite' ), esc_url( dokan_edit_product_url( intval( $get_data['created_product'] ) ) ), get_the_title( intval( $get_data['created_product'] ) ) ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped ?>
                    </div>
                <?php endif ?>
                ...
                if ( $can_sell ) {
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        ...
                        <form class="dokan-form-container" method="post">
                            ...
                            <div class="product-edit-container dokan-clearfix">
                                    ...
                                    <div class="featured-image">
                                        <div class="dokan-feat-image-upload">
                                            <div class="instruction-inside <?php echo esc_attr( $hide_instruction ); ?>">
                                                ...
                                                <a href="#" class="dokan-feat-image-btn dokan-btn"><?php esc_html_e( 'تحميل صورة المنتج', 'dokan-lite' ); ?></a>
                                            </div>
                                            ...
                                            <div id="product_images_container">
                                                <ul class="product_images dokan-clearfix">
                                                    <?php
                                                        ...
                                                        ?>
                                                    <li class="add-image add-product-images tips" data-title="<?php esc_attr_e( 'إضافة صورة المعرض', 'dokan-lite' ); ?>">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    <div class="dokan-form-group">
                                        <input class="dokan-form-control" name="post_title" id="post-title" type="text" placeholder="<?php esc_attr_e( 'اسم المنتج..', 'dokan-lite' ); ?>" value="<?php echo esc_attr( dokan_posted_input( 'post_title' ) ); ?>">
                                    </div>

                                    <div class="dokan-form-group">
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            <div class="content-half-part">
                                                <label for="_regular_price" class="dokan-form-label"><?php esc_html_e( 'السعر', 'dokan-lite' ); ?></label>
                                            ...
                                            <div class="content-half-part sale-price">
                                                <label for="_sale_price" class="form-label">
                                                    ...
                                                    <a href="#" class="sale_schedule"><?php esc_html_e( 'جدول', 'dokan-lite' ); ?></a>
                                                    <a href="#" class="cancel_sale_schedule dokan-hide"><?php esc_html_e( 'إلغاء', 'dokan-lite' ); ?></a>
                                                </label>
                                    ...
                                    <div class="dokan-form-group">
                                        <textarea name="post_excerpt" id="post-excerpt" rows="5" class="dokan-form-control" placeholder="<?php esc_attr_e( 'وصف قصير للمنتج...', 'dokan-lite' ); ?>"><?php echo esc_attr( dokan_posted_textarea( 'post_excerpt' ) ); ?></textarea>
                                    </div>
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group">
                                            ...
                                            $category_args =  array(
                                                'show_option_none' => __( '- اختر تصنبف -', 'dokan-lite' ),
                                                'hierarchical'     => 1,
                                                'hide_empty'       => 0,
                                                'name'             => 'product_cat',
                                                'id'               => 'product_cat',
                                    ...
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group">
                                            ...
                                            echo str_replace( '<select', '<select data-placeholder="'.esc_attr__( 'احتر فئات المنتج', 'dokan-lite' ).'" multiple="multiple" ', $drop_down_category ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
                                            ?>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        echo str_replace( '<select', '<select data-placeholder="'.esc_attr__( 'حدد علامات المنتج', 'dokan-lite' ).'" multiple="multiple" ', $drop_down_tags ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
                                        ?>
                                    </div>
                            ...
                            <div class="dokan-form-group">
                                <label for="post_content" class="control-label"><?php esc_html_e( 'وصف', 'dokan-lite' ) ?> <i class="fa fa-question-circle tips" data-title="<?php esc_attr_e( 'إضافة وصف المنتج الخاص بك', 'dokan-lite' ) ?>" aria-hidden="true"></i></label>
                            ...
                            <div class="dokan-form-group dokan-right">
                                ...
                                <button type="submit" name="add_product" class="dokan-btn dokan-btn-default" value="create_and_add_new"><?php esc_attr_e( 'انشاء و اضف جدبد', 'dokan-lite' ); ?></button>
                                <button type="submit" name="add_product" class="dokan-btn dokan-btn-default dokan-btn-theme" value="create_new"><?php esc_attr_e( 'انشاء منتج', 'dokan-lite' ); ?></button>
                            </div>
