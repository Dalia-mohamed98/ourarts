...
if ( !isset( $post->ID ) && ! isset( $_GET['product_id'] ) ) {
    wp_die( esc_html__( 'م رفض الوصول ، لم يتم العثور على أي منتج', 'dokan-lite' ) );
}
...
if ( ! dokan_is_product_author( $post_id ) ) {
    wp_die( esc_html__( 'تم الرفض', 'dokan-lite' ) );
    exit();
}
        ...
        <div class="dokan-dashboard-content dokan-product-edit">
            ...
            <header class="dokan-dashboard-header dokan-clearfix">
                <h1 class="entry-title">
                    <?php esc_html_e( 'تعديل المنتج', 'dokan-lite' ); ?>
                    ...
                    <?php if ( $post->post_status == 'publish' ) { ?>
                        <span class="dokan-right">
                            <a class="dokan-btn dokan-btn-theme dokan-btn-sm" href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" target="_blank"><?php esc_html_e( 'عرض المنتج', 'dokan-lite' ); ?></a>
                        </span>
                    <?php } ?>

                    <?php if ( $_visibility == 'hidden' ) { ?>
                        <span class="dokan-right dokan-label dokan-label-default dokan-product-hidden-label"><i class="fa fa-eye-slash"></i> <?php esc_html_e( 'مخفي', 'dokan-lite' ); ?></span>
                    <?php } ?>
                </h1>
            </header><!-- .entry-header -->
            ...
            <div class="product-edit-new-container product-edit-container">
                <?php if ( Dokan_Template_Products::$errors ) { ?>
                    <div class="dokan-alert dokan-alert-danger">
                        ...
                        <?php foreach ( Dokan_Template_Products::$errors as $error) { ?>
                            <strong><?php esc_html_e( 'خطأ!', 'dokan-lite' ); ?></strong> <?php echo esc_html( $error ) ?>.<br>
                        <?php } ?>
                    </div>
                <?php } ?>
                ...
                <?php if ( isset( $_GET['message'] ) && $_GET['message'] == 'success') { ?>
                    <div class="dokan-message">
                        ...
                        <strong><?php esc_html_e( 'عمل ناجح!', 'dokan-lite' ); ?></strong> <?php esc_html_e( 'تم حفظ المنتج بنجاح.', 'dokan-lite' ); ?>

                        <?php if ( $post->post_status == 'publish' ) { ?>
                            <a href="<?php echo esc_url( get_permalink( $post_id ) ); ?>" target="_blank"><?php esc_html_e( 'عرض المنتج &rarr;', 'dokan-lite' ); ?></a>
                        <?php } ?>
                    </div>
                <?php } ?>
                    ...
                    if ( dokan_is_seller_enabled( get_current_user_id() ) ) { ?>
                        <form class="dokan-product-edit-form" role="form" method="post">
                            ...
                            <div class="dokan-form-top-area">
                                ...
                                <div class="content-half-part dokan-product-meta">
                                    ...
                                    <div class="dokan-form-group">
                                        ...
                                        <label for="post_title" class="form-label"><?php esc_html_e( 'العنوان', 'dokan-lite' ); ?></label>
                                        <?php dokan_post_input_box( $post_id, 'post_title', array( 'placeholder' => __( 'اسم المنتج..', 'dokan-lite' ), 'value' => $post_title ) ); ?>
                                        <div class="dokan-product-title-alert dokan-hide">
                                            <?php esc_html_e( 'الرجاء إدخال اسم المنتج!', 'dokan-lite' ); ?>
                                        </div>
                                    </div>
                                    ...
                                    <?php if ( is_array( $product_types ) ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_type" class="form-label"><?php esc_html_e( 'نوع المنتج', 'dokan-lite' ); ?> <i class="fa fa-question-circle tips" aria-hidden="true" data-title="<?php esc_html_e( 'اختر "متغير" إذا كان لمنتجك سمات متعددة - مثل الأحجام والألوان والجودة وما إلى ذلك', 'dokan-lite' ); ?>"></i></label>
                                    ...
                                    <div class="show_if_simple dokan-clearfix">
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            ...
                                            <div class="content-half-part regular-price">
                                                <label for="_regular_price" class="form-label"><?php esc_html_e( 'السعر', 'dokan-lite' ); ?>
                                                    <span class="vendor-earning" data-commission="<?php echo esc_attr( dokan_get_seller_percentage( dokan_get_current_user_id(), $post_id ) ); ?>" data-commission_type="<?php echo esc_attr( dokan_get_commission_type( dokan_get_current_user_id(), $post_id ) ); ?>">( <?php esc_html_e( ' انت تكسب : ', 'dokan-lite' ) ?><?php echo esc_html( get_woocommerce_currency_symbol() ); ?><span class="vendor-price">0.00</span> )</span>
                                                </label>
                                            ...
                                            <div class="content-half-part sale-price">
                                                <label for="_sale_price" class="form-label">
                                                    <?php esc_html_e( 'سعر مخفض', 'dokan-lite' ); ?>
                                                    <a href="#" class="sale_schedule <?php echo ($show_schedule ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'جدول', 'dokan-lite' ); ?></a>
                                                    <a href="#" class="cancel_sale_schedule <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>"><?php esc_html_e( 'إلغاء', 'dokan-lite' ); ?></a>
                                                </label>
                                        ...
                                        <div class="dokan-form-group dokan-clearfix dokan-price-container">
                                            <div class="dokan-product-less-price-alert dokan-hide">
                                                <?php esc_html_e('لا يمكن أن يكون سعر المنتج أقل من رسوم التاجر!', 'dokan-lite' ); ?>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sale_price_dates_fields dokan-clearfix dokan-form-group <?php echo ( ! $show_schedule ) ? 'dokan-hide' : ''; ?>">
                                            <div class="content-half-part from">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php esc_html_e( 'من', 'dokan-lite' ); ?></span>
                                            ...
                                            <div class="content-half-part to">
                                                <div class="dokan-input-group">
                                                    <span class="dokan-input-group-addon"><?php esc_html_e( 'ل', 'dokan-lite' ); ?></span>
                                    ...
                                    <?php if ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'single' ): ?>
                                        <div class="dokan-form-group">
                                            <label for="product_cat" class="form-label"><?php esc_html_e( 'الفئة', 'dokan-lite' ); ?></label>
                                            <?php
                                            $product_cat = -1;
                                            $term = array();
                                            ...
                                            $category_args =  array(
                                                'show_option_none' => __( '- اختر الفئة -', 'dokan-lite' ),
                                                'hierarchical'     => 1,
                                                'hide_empty'       => 0,
                                                'name'             => 'product_cat',
                                                'id'               => 'product_cat',
                                        ...
                                        ?>
                                            <div class="dokan-product-cat-alert dokan-hide">
                                                <?php esc_html_e('يرجى اختيار فئة!', 'dokan-lite' ); ?>
                                            </div>
                                        </div>
                                    <?php elseif ( dokan_get_option( 'product_category_style', 'dokan_selling', 'single' ) == 'multiple' ): ?>
                                        <div class="dokan-form-group">
                                            ...
                                            echo str_replace( '<select', '<select data-placeholder="' . esc_html__( 'اختر فئات المنتج', 'dokan-lite' ) . '" multiple="multiple" ', $drop_down_category ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
                                            ?>
                                        </div>
                                    <?php endif; ?>

                                    <div class="dokan-form-group">
                                        <label for="product_tag" class="form-label"><?php esc_html_e( 'شعارات', 'dokan-lite' ); ?></label>
                                        <?php
                                        ...
                                        echo str_replace( '<select', '<select data-placeholder="' . esc_html__( 'اختر شعارات المنتج', 'dokan-lite' ) . '" multiple="multiple" ', $drop_down_tags ); // phpcs:ignore WordPress.XSS.EscapeOutput.OutputNotEscaped
                                ...
                                <div class="content-half-part featured-image">
                                    ...
                                    <div class="dokan-feat-image-upload dokan-new-product-featured-img">
                                        ...
                                        <div class="instruction-inside<?php echo esc_attr( $instruction_class ); ?>">
                                            ...
                                            <a href="#" class="dokan-feat-image-btn btn btn-sm"><?php esc_html_e( 'قم بتحميل صورة غلاف المنتج', 'dokan-lite' ); ?></a>
                                        </div>
                                                        ...
                                                        if ( $gallery ) {
                                                            foreach ($gallery as $image_id) {
                                                                ...
                                                                <li class="image" data-attachment_id="<?php echo esc_attr( $image_id ); ?>">
                                                                    ...
                                                                    <a href="#" class="action-delete" title="<?php esc_attr_e( 'حذف الصورة', 'dokan-lite' ); ?>">&times;</a>
                                                                </li>
                                                                <?php
                                                            }
                                                        }
                                                        ?>
                                                        <li class="add-image add-product-images tips" data-title="<?php esc_html_e( 'إضافة صورة المعرض', 'dokan-lite' ); ?>">
                            ...
                            <div class="dokan-product-short-description">
                                <label for="post_excerpt" class="form-label"><?php esc_html_e( 'وصف قصير', 'dokan-lite' ); ?></label>
                            ...
                            <div class="dokan-product-description">
                                <label for="post_content" class="form-label"><?php esc_html_e( 'وصف', 'dokan-lite' ); ?></label>
                            ...
                            <input type="hidden" name="dokan_update_product" value="<?php esc_attr_e( 'حفظ المنتج', 'dokan-lite' ); ?>"/>
                            <input type="submit" name="dokan_update_product" class="dokan-btn dokan-btn-theme dokan-btn-lg dokan-right" value="<?php esc_attr_e( 'حفظ المنتج', 'dokan-lite' ); ?>"/>
