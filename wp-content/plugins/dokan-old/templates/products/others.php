<div class="dokan-other-options dokan-edit-row dokan-clearfix <?php echo esc_attr( $class ); ?>">
    <div class="dokan-section-heading" data-togglehandler="dokan_other_options">
        <h2><i class="fa fa-cog" aria-hidden="true"></i> <?php esc_html_e( 'خيارات أخرى', 'dokan-lite' ); ?></h2>
        <p><?php esc_html_e( 'اضبط خيارات المنتج الإضافي', 'dokan-lite' ); ?></p>
    ...
    <div class="dokan-section-content">
        <div class="dokan-form-group content-half-part">
            <label for="post_status" class="form-label"><?php esc_html_e( 'حالة المنتج', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group content-half-part">
            <label for="_visibility" class="form-label"><?php esc_html_e( 'الرؤية', 'dokan-lite' ); ?></label>
        ...
        <div class="dokan-form-group">
            <label for="_purchase_note" class="form-label"><?php esc_html_e( 'شراء ملاحظة', 'dokan-lite' ); ?></label>
            <?php dokan_post_input_box( $post_id, '_purchase_note', array( 'placeholder' => __( 'سيحصل العملاء على هذه المعلومات في بريدهم الإلكتروني', 'dokan-lite' ) ), 'textarea' ); ?>
        </div>

        <div class="dokan-form-group">
            <?php $_enable_reviews = ( $post->comment_status == 'open' ) ? 'yes' : 'no'; ?>
            <?php dokan_post_input_box( $post_id, '_enable_reviews', array('value' => $_enable_reviews, 'label' => __( 'تمكين مراجعات المنتجات', 'dokan-lite' ) ), 'checkbox' ); ?>
        </div>
