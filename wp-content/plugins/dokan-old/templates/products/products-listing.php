                ...
                <div class="dokan-dashboard-product-listing-wrapper">
                    ...
                    <form id="product-filter" method="POST" class="dokan-form-inline">
                        <div class="dokan-form-group">
                            <label for="bulk-product-action-selector" class="screen-reader-text"><?php esc_html_e( 'اختيار العمل للكل', 'dokan-lite' ); ?></label>
                        ...
                        <div class="dokan-form-group">
                            ...
                            <input type="submit" name="bulk_product_status_change" id="bulk-product-action" class="dokan-btn dokan-btn-theme" value="<?php esc_attr_e( 'تطبيق', 'dokan-lite' ); ?>">
                        </div>
                        <table class="dokan-table dokan-table-striped product-listing-table dokan-inline-editable-table" id="dokan-product-list-table">
                            <thead>
                                <tr>
                                    ...
                                    <th><?php esc_html_e( 'الصورة', 'dokan-lite' ); ?></th>
                                    <th><?php esc_html_e( 'الإسم', 'dokan-lite' ); ?></th>
                                    ...
                                    <th><?php esc_html_e( 'المخزون', 'dokan-lite' ); ?></th>
                                    <th><?php esc_html_e( 'السعر', 'dokan-lite' ); ?></th>
                                    <th><?php esc_html_e( 'المكسب', 'dokan-lite' ); ?></th>
                                    <th><?php esc_html_e( 'النوع', 'dokan-lite' ); ?></th>
                                    <th><?php esc_html_e( 'المشاهدة', 'dokan-lite' ); ?></th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td colspan="7"><?php esc_html_e( 'لم يتم العثور على منتج', 'dokan-lite' ); ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
