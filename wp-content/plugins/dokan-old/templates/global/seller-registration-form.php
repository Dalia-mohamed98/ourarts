...
<div class="show_if_seller" style="<?php echo esc_attr( $role_style ); ?>">
    ...
    if ( 'on' === $show_terms_condition && $terms_condition_url ) { ?>
        <p class="form-row form-group form-row-wide">
            ...
            <label style="display: inline" for="tc_agree"><?php echo sprintf( __( 'لقد قرأت ووافقت على ال <a target="_blank" href="%s">الشروط و الأحكام</a>.', 'dokan-lite' ), esc_url( $terms_condition_url ) ); ?></label>
        </p>
    <?php }
