    ...
    <div id="wf-tab-content1" class="wf-tab-content">
        <table class="table tree widefat fixed sorted_table mtable" width="100%" id="table-1">
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Article number in shop" />
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Product group in shop" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Product characteristics" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Colour" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Cash in advance" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Unit price" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="mattributes[]" autocomplete="off" required
                           class="wf_validate_attr wf_mattributes wf_mattr" value="Energy efficiency rating" />
                </td>
                <td>
                    <input type="text" name="prefix[]" autocomplete="off" class="wf_ps"/>
                </td>
