		...
		switch ( $args['type'] ) {
			...
			case 'tel':
				$options = '<option value="">اختر المدينة…</option>
					<option value="12511">الهرم</option>
					<option value="12511">الجيزة</option>
					<option value="12511">فيصل</option>
					<option value=" 11561">الزمالك</option>
					<option value="12611">الدقي</option>
					<option value="12611">المهندسين</option>
					<option value="11511">وسط البلد</option>
					<option value="12566">مدينة السادس من أكتوبر</option>
					<option value="12588">الشيخ زايد</option>
					<option value="11736">مصر الجديدة</option>
					<option value="11765">مدينة نصر</option>
					<option value="11865">القاهرة الجديدة</option>
					<option value="11728">المعادي</option>
					<option value="11731">حلوان</option>
					<option value="11517">العباسية</option>
					<option value="11672">شبرا</option>
					<option value="12651">إمبابة</option>
					<option value="13752">شبرا الخيمة</option>
					<option value="11571">المقطم</option>
					<option value="11841">رحاب</option>
					<option value="19519">مدينتي</option>
					<option value="11828">العبور</option>
					<option value="44629">مدينة العاشر من رمضان</option>
					<option value="11837">الشروق</option>
					<option value="21532">الإسكندرية</option>
					<option value="41611">الإسماعيلية</option>
					<option value="42534">بورسعيد</option>
					<option value="43527">السويس</option>
					<option value="13511">القليوبية</option>
					<option value="32817">المنوفية</option>
					<option value="35511">المنصورة</option>
					<option value="33511">كفرالشيخ</option>
					<option value="44511">الشرقية</option>
					<option value="40540">البحيرة</option>
					<option value="62511">بني سويف</option>
					<option value="63512">الفيوم</option>
					<option value="61111">المنيا</option>
					<option value="71511">أسيوط</option>
					<option value="82749">سوهاج</option>
					<option value="83511">قنا</option>
					<option value="85952">الأقصر</option>
					<option value="81511">أسوان</option>
					<option value="46628">شرم الشيخ</option>
					<option value="84517">الغردقة</option>
					<option value="51511">مرسى مطروح</option>
					<option value="22856">الوادي الجديد</option>
					<option value="51714">الواحات</option>
					<option value="23611">الساحل الشمالي</option>
					<option value="43552">السخنة</option>
					<option value="31511">طنطا</option>
					<option value="31951">المحلة</option>
					<option value="11788">مدينة السلام</option>
					<option value="32958">مدينة السادات</option>
					<option value="32512">شبين الكوم</option>
					<option value="22516">دمنهور</option>
					<option value="34511">دمياط</option>';
				if(esc_attr( $key ) == "billing_city" ){
					$field.= '<select onchange="postcodeB();" name="' . esc_attr( $key ) . '" id="' . esc_attr( $args['id'] ) . '" class="select ' . esc_attr( implode( ' ', $args['input_class'] ) ) . '" ' . implode( ' ', $custom_attributes ) . ' data-placeholder="' . esc_attr( $args['placeholder'] ) . '">'.$options.'</select>
					<script> 
					function postcodeB(){
							var x = document.getElementById("billing_city").value;
							document.getElementById("billing_postcode").value = x;
					};
					</script>';
				}
				else if(esc_attr( $key ) == "shipping_city" ){
					$field.= '<select onchange="postcodeS();" name="' . esc_attr( $key ) . '" id="' . esc_attr( $args['id'] ) . '" class="select ' . esc_attr( implode( ' ', $args['input_class'] ) ) . '" ' . implode( ' ', $custom_attributes ) . ' data-placeholder="' . esc_attr( $args['placeholder'] ) . '">'.$options.'</select>
					<script> 
					function postcodeS(){
							var x = document.getElementById("shipping_city").value;
							document.getElementById("shipping_postcode").value = x;
					};
					</script>';
				}
