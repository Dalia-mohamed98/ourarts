...
$link_info  = wp_kses(
	sprintf( __( 'يمكنك أيضا إضافة <code>?%s=%s</code> إلى أي رابط على %s لتتبع التحويلات من حسابك.', 'affiliates' ), $pname, $encoded_id, esc_url( home_url() ) ),
	array( 'code' => array(), 'a' => array( 'href' => array() ) )
);
?>
<h2><?php esc_html_e( 'نظرة عامة', 'affiliates' ); ?></h2>
<div class="dashboard-section dashboard-section-overview">
	<div class="stats-container">
		<div class="stats-item">
			<div class="stats-item-heading"><?php _e( 'اخر الزيارات', 'affiliates' ); ?></div>
			<div class="stats-item-value"><?php echo esc_html( $visits ); ?></div>
		</div>
		<div class="stats-item">
			<div class="stats-item-heading"><?php _e( 'التحويلات الاخيرة', 'affiliates' ); ?></div>
			<div class="stats-item-value"><?php echo esc_html( $referrals ); ?></div>
		</div>
		<div class="stats-item">
			<div class="stats-item-heading"><?php _e( 'الأرباح الأخيرة', 'affiliates' )?></div>
	...
	<br/>
	<h3><?php esc_html_e( 'الرابط', 'affiliates' ); ?></h3>
	<div class="affiliates-dashboard-overview-link">
		<p><?php esc_html_e( 'الرابط الخاص بك', 'affiliates' ); ?></p>
		<p>
		...
		<p>
			<span class="button copy-to-clipboard-trigger" data-source="copy-to-clipboard-source"><?php esc_html_e( 'نسخ', 'affiliates' ); ?></span>
		</p>
		<p>
			<?php echo $link_info; ?>
		</p>
	...
	<div class="affiliates-dashboard-logout">
		<a href="<?php echo esc_url( wp_logout_url( home_url() ) ) ?>"><?php esc_html_e( 'تسجيل الخروج', 'affiliates' ); ?></a>
	</div>
